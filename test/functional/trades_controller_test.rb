...
class TradesControllerTest < ActionController::TestCase
  ...
  test "should create trade" do
    assert_difference('Trade.count') do
      post :create, trade: { price: @trade.price, quantity: @trade.quantity, stock_id: @trade.stock_id, trader_id: @trade.trader_id }
    end
  ...
  test "should update trade" do
    put :update, id: @trade, trade: { price: @trade.price, quantity: @trade.quantity, stock_id: @trade.stock_id, trader_id: @trade.trader_id }
    assert_redirected_to trade_path(assigns(:trade))
  end
